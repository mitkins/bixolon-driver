...
/**
 * The <em>command instruction(s)</em> can be found on <b>page 70</b> from 'commands manual'.
 *
 * @author ksaric
 */

public class QrCodeStore implements QrControlSequence {

    // TODO: use a validation table.
    ...
    private QrCodeStore( final byte[] data ) {
        this.data = data;
    }

    public static QrCodeStore createQrCodeStore( final byte[] data ) {
        return new QrCodeStore( data );
    }
    ...
    public byte[] getCommand() {
        ...
        return new byte[]{(byte) 29, (byte) 40, (byte) 107, (byte) pL, (byte) pH, (byte) 49, (byte) 80, (byte) 48};
    }
